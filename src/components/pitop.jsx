...
export default function PiTop()
{
    return(<div className="fixed">
        <div className="flex bg-white w-screen">
        <a href="/"><img src="\assets\logo.png" alt="GCS-COOLING" className="max-w-20 max-h-20" /></a>
        <a href="/"><div className="hidden md:text-2xl text-center font-bold text-white bg-blue-500 rounded-full p-4 mb-2 mt-2 ml-4"><h1>GANGA COOLING SOLUTIONS</h1></div></a>
        ...
        <AnchorLink href="#ac"><h1 className="things hover:bg-blue-800" onClick={close}>DOMESTIC WATER PURIFIER</h1></AnchorLink>
        <AnchorLink href="#wp"><h1 className="things hover:bg-blue-800" onClick={close}>COMMERCIAL WATER PURIFIER</h1></AnchorLink>
