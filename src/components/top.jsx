...
export default function Top()
{
    return(<div className="flex flex-row bg-blue-500 place-content-around gap-20 fixed w-screen header">
        <img src="src\assets\logo.png" alt="GCS-COOLING" className="max-w-20 max-h-20 p-2" />
        ...
        <AnchorLink href="#fac"><h1 className="things hover:bg-blue-800">FACILITIES</h1></AnchorLink>
