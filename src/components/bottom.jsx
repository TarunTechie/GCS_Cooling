export default function Bottom()
{
    return(
        ...
        <div className="text-white font-bold">
            ...
            <a href="https://maps.app.goo.gl/sk8WLS3c1SgFPy5y6" target="blank"><span className="flex flex-row pb-5"><img src="assets/icons/location.svg" alt="ADDRESS" className="pr-3"/>
